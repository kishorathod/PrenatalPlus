      ...
      >
        ...
        {enableGlow && (
          <div
            ...
            style={{
              WebkitMaskImage: `radial-gradient(circle var(--glow-radius) at var(--x) var(--y), black 10%, transparent 50%)`,
              maskImage: `radial-gradient(circle var(--glow-radius) at var(--x) var(--y), black 10%, transparent 50%)`,
          ...
          >
            ...
            >
              {React.Children.map(children, (child, index) => {
                if (React.isValidElement(child) && (child.type === GlowingCard || (child.type as any).displayName === "GlowingCard")) {
                  ...
                  return React.cloneElement(child as React.ReactElement<any>, {
                    ...
                    style: {
                      ...child.props.style,
                      backgroundImage: "none", // Force remove gradient from glow layer
